              ...
              <div className="bg-slate-50 p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-900">{selectedAgreement.ownerDetails?.gender || 'Not provided'}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-900">{selectedAgreement.ownerDetails?.aadhar || 'Not provided'}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-slate-700">PAN Number</label>
                    <p className="mt-1 text-sm text-gray-900">{selectedAgreement.ownerDetails?.pan || 'Not provided'}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="border border-slate-200 rounded-lg overflow-hidden shadow-sm">
              ...
              <div className="bg-slate-50 p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div>
                    <label className="text-sm font-medium text-slate-700">Gender</label>
                    <p className="mt-1 text-sm text-gray-900">{selectedAgreement.tenantDetails?.gender || 'Not provided'}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-slate-700">Mobile Number</label>
                  ...
                  <div>
                    <label className="text-sm font-medium text-slate-700">Aadhar Number</label>
                    <p className="mt-1 text-sm text-gray-900">{selectedAgreement.tenantDetails?.aadhar || 'Not provided'}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-slate-700">PAN Number</label>
                    <p className="mt-1 text-sm text-gray-900">{selectedAgreement.tenantDetails?.pan || 'Not provided'}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-slate-50 p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-900 font-medium">{selectedAgreement.propertyDetails?.type || 'Not provided'}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-slate-700">Area (sq ft)</label>
                    <p className="mt-1 text-sm text-gray-900">{selectedAgreement.propertyDetails?.areaSqft || 'Not provided'}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-900">{selectedAgreement.propertyDetails?.furnishing || 'Not provided'}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-slate-700">Floor</label>
                    <p className="mt-1 text-sm text-gray-900">{selectedAgreement.propertyDetails?.floor || 'Not provided'}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-slate-700">Total Floors</label>
                    <p className="mt-1 text-sm text-gray-900">{selectedAgreement.propertyDetails?.totalFloors || 'Not provided'}</p>
                  </div>
                  <div className="col-span-full">
              ...
              <div className="bg-slate-50 p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div>
                    ...
                    <p className="mt-1 text-lg text-gray-900 font-bold text-green-600">₹{selectedAgreement.rentalTerms?.monthlyRent || 'Not provided'}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-slate-700">Security Deposit</label>
                    <p className="mt-1 text-lg text-gray-900 font-bold text-blue-600">₹{selectedAgreement.rentalTerms?.securityDeposit || 'Not provided'}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    <label className="text-sm font-medium text-slate-700">Lock-in Period</label>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-900">₹{selectedAgreement.rentalTerms?.lateFeeAmount || 'Not provided'}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-slate-700">Maintenance</label>
                    <p className="mt-1 text-sm text-gray-900">{selectedAgreement.rentalTerms?.maintenanceIncluded ? 'Included' : 'Excluded'}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-slate-700">Parking</label>
                    <p className="mt-1 text-sm text-gray-900">{selectedAgreement.rentalTerms?.parkingIncluded ? 'Included' : 'Not Included'}</p>
                  </div>
                </div>
              </div>
            </div>
