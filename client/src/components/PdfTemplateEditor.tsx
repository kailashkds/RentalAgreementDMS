...
const DYNAMIC_FIELDS = {
  owner: [
    ...
    { key: "{{OWNER_MOBILE}}", label: "Owner Mobile Number" },
    { key: "{{OWNER_EMAIL}}", label: "Owner Email" },
    { key: "{{OWNER_AADHAR}}", label: "Owner Aadhaar Number" },
    { key: "{{OWNER_PAN}}", label: "Owner PAN Number" },
  ],
  tenant: [
    ...
    { key: "{{TENANT_MOBILE}}", label: "Tenant Mobile Number" },
    { key: "{{TENANT_EMAIL}}", label: "Tenant Email" },
    { key: "{{TENANT_AADHAR}}", label: "Tenant Aadhaar Number" },
    { key: "{{TENANT_PAN}}", label: "Tenant PAN Number" },
  ],
  property: [
  ...
  rental: [
    ...
    { key: "{{RENT_AMOUNT_WORDS}}", label: "Rent Amount (English Words)" },
    { key: "{{MONTHLY_RENT_WORDS_GUJARATI}}", label: "Rent Amount (Gujarati Words)" },
    { key: "{{SECURITY_DEPOSIT}}", label: "Security Deposit (Number)" },
    { key: "{{SECURITY_DEPOSIT_WORDS}}", label: "Security Deposit (English Words)" },
  ...
  gujarati: [
    { key: "{{CURRENT_DAY}}", label: "Current Day (Gujarati)" },
    { key: "{{CURRENT_DATE_GUJARATI}}", label: "Current Date (Gujarati)" },
    { key: "{{CURRENT_MONTH_GUJARATI}}", label: "Current Month (Gujarati)" },
    { key: "{{CURRENT_YEAR}}", label: "Current Year (Gujarati)" },
    { key: "{{START_DATE_GUJARATI}}", label: "Start Date (Gujarati)" },
