...
- **PDF Page Numbering**: Automatic "Page X of Y" footer numbering added to all generated PDF documents. Updated on August 18, 2025 to include professional page numbering at bottom center with increased bottom margin for proper spacing. Gujarati PDF templates updated to include page numbering functionality.
- **PDF Download System**: Browser-compatible PDF download system that bypasses popup blockers by downloading HTML files directly to user's computer. Users can then open the HTML file and use Ctrl+P/Cmd+P to save as PDF. Updated on August 18, 2025 to resolve popup blocking issues.
